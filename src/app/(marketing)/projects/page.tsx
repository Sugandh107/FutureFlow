                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-center">
                                ...
                                <div className={`${index % 2 === 1 ? 'lg:order-1' : ''} relative pt-8 pb-8 md:py-12 px-2 bg-transparent w-full overflow-hidden`}>
                                    <div className="absolute md:top-[10%] left-1/2 gradient w-3/4 max-w-sm -translate-x-1/2 h-1/4 md:h-1/3 inset-0 blur-[5rem] animate-image-glow"></div>
